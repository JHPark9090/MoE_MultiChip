...
#SBATCH --output=logs/ArbitrarySplit_v3_Q2_ADHD_%j.out
#SBATCH --error=logs/ArbitrarySplit_v3_Q2_ADHD_%j.err
#SBATCH --job-name=ASv3_Q2
...
python CircuitMoE_v2_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2025 \
    --job-id="${SLURM_JOB_ID:-ASv3_Q2_ADHD_local}" \
