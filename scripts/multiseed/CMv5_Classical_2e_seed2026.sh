...
#SBATCH --output=logs/CMv5_C2_ADHD_s2026_%j.out
#SBATCH --error=logs/CMv5_C2_ADHD_s2026_%j.err
#SBATCH --job-name=C2_s26
...
# v5: Corrected Yeo17 mapping, seed=2026
python CircuitMoE_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2026 \
    --job-id="${SLURM_JOB_ID:-CMv5_C2_ADHD_s2026}" \
