...
#SBATCH --output=logs/CMv5_C2_ADHD_s2028_%j.out
#SBATCH --error=logs/CMv5_C2_ADHD_s2028_%j.err
#SBATCH --job-name=C2_s28
...
# v5: Corrected Yeo17 mapping, seed=2028
python CircuitMoE_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2028 \
    --job-id="${SLURM_JOB_ID:-CMv5_C2_ADHD_s2028}" \
