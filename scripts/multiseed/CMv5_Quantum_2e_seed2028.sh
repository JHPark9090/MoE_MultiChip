...
#SBATCH --output=logs/CMv5_Q8_2e_ADHD_s2028_%j.out
#SBATCH --error=logs/CMv5_Q8_2e_ADHD_s2028_%j.err
#SBATCH --job-name=Q2_s28
...
# v5: Corrected Yeo17 mapping, 8-qubit, degree=3, 2-expert, seed=2028
python CircuitMoE_v2_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2028 \
    --job-id="${SLURM_JOB_ID:-CMv5_Q8_2e_ADHD_s2028}" \
