...
#SBATCH --output=logs/CMv5_C4_ADHD_s2024_%j.out
#SBATCH --error=logs/CMv5_C4_ADHD_s2024_%j.err
#SBATCH --job-name=C4_s24
...
# v5: Corrected Yeo17 mapping, seed=2024
python CircuitMoE_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2024 \
    --job-id="${SLURM_JOB_ID:-CMv5_C4_ADHD_s2024}" \
