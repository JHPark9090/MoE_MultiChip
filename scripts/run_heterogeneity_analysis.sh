...
#SBATCH --output=logs/heterogeneity_analysis_%j.out
#SBATCH --error=logs/heterogeneity_analysis_%j.err
#SBATCH --job-name=heterog
...
echo ""
echo "============================================"
echo "All heterogeneity analyses complete!"
echo "============================================"
