...
#SBATCH --output=logs/CMv5_Q8d2_2e_ADHD_%j.out
#SBATCH --error=logs/CMv5_Q8d2_2e_ADHD_%j.err
#SBATCH --job-name=CMv5_Q8d2_2
...
# v5: Corrected Yeo17 mapping, 8-qubit, degree=2, 2-expert
python CircuitMoE_v2_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2025 \
    --job-id="${SLURM_JOB_ID:-CMv5_Q8d2_2e_ADHD_local}" \
