...
#SBATCH --output=logs/ASD_coherence_clustering_site_regressed_%j.out
#SBATCH --error=logs/ASD_coherence_clustering_site_regressed_%j.err
#SBATCH --job-name=ASD_coh_clust
...
python abcd_fc_clustering.py \
    ...
    --output-dir=./results/asd_coherence_clustering_site_regressed \
