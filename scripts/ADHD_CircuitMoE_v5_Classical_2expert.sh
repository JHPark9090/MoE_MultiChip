...
#SBATCH --output=logs/CMv5_C2_ADHD_%j.out
#SBATCH --error=logs/CMv5_C2_ADHD_%j.err
#SBATCH --job-name=CMv5_C2
...
# v5: Corrected Yeo17 mapping (validated via volumetric overlap)
python CircuitMoE_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2025 \
    --job-id="${SLURM_JOB_ID:-CMv5_C2_ADHD_local}" \
