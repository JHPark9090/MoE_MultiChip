...
#SBATCH --output=logs/CircuitMoE_v4_Q3_ADHD_%j.out
#SBATCH --error=logs/CircuitMoE_v4_Q3_ADHD_%j.err
#SBATCH --job-name=CMv4_Q3
...
python CircuitMoE_v2_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2025 \
    --job-id="${SLURM_JOB_ID:-CMv4_Q3_ADHD_local}" \
