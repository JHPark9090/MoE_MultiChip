...
#SBATCH --output=logs/SingleExpert_Classical_ASD_%j.out
#SBATCH --error=logs/SingleExpert_Classical_ASD_%j.err
#SBATCH --job-name=SE_C_ASD
...
python SingleExpertBaseline_ABCD.py \
    ...
    --sample-size=0 \
    --seed=2025 \
    --job-id="${SLURM_JOB_ID:-SE_C_ASD_local}" \
