...
#SBATCH --output=logs/Sex_coherence_clustering_site_regressed_%j.out
#SBATCH --error=logs/Sex_coherence_clustering_site_regressed_%j.err
#SBATCH --job-name=Sex_coh_clust
...
python abcd_fc_clustering.py \
    ...
    --output-dir=./results/sex_coherence_clustering_site_regressed \
